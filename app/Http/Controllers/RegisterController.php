...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        return view('auth.register', ['url' => 'restaurant']);
    }
    ...
    protected function createrestaurant(Request $request)
    {
        ...
        Restaurant::create([
            'Restro_name' => $request->name,
            'Restro_email' => $request->email,
            'password' => Hash::make($request->password),
            'Restro_location' => $request->location,
        ]);
    ...
    protected function createcustomer(Request $request)
    {
        ...
        Customer::create([
            ...
            'password' => Hash::make($request->password),
            'Customer_preference' => $request->location,
        ]);
